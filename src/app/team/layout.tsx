...
export const metadata: Metadata = {
  ...
  description:
    "Meet the Capital Direct Funding team. Founded by Frank Williams with Juan Williams as Broker of Record. 11 professionals dedicated to fast, flexible private lending for California real estate.",
  openGraph: {
