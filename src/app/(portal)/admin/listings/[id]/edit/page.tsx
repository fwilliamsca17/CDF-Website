    ...
    <main className="container-cdf py-12 space-y-8">
      ...
      <ListingEditor
        initial={{
          ...
          net_investor_rate_pct: listing.net_investor_rate_pct,
          servicing_spread_pct: listing.servicing_spread_pct,
          borrower_note_rate_pct: listing.borrower_note_rate_pct,
          funding_structure: listing.funding_structure,
          fund_retained_amount: listing.fund_retained_amount,
          min_investment: listing.min_investment,
          assignment_status: listing.assignment_status,
          funds_status: listing.funds_status,
          assignment_process_notes: listing.assignment_process_notes,
          public_visibility: listing.public_visibility,
          public_disclaimer: listing.public_disclaimer,
