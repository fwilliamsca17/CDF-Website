...
const STATIC_ROUTES: {
  ...
  { path: "/professionals/escrow-title", changeFrequency: "monthly", priority: 0.8 },
  { path: "/professionals/fiduciaries", changeFrequency: "monthly", priority: 0.8 },
  { path: "/professionals/contractors", changeFrequency: "monthly", priority: 0.8 },
  { path: "/professionals/financial-advisors", changeFrequency: "monthly", priority: 0.8 },
